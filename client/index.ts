...
// let fbVel: Float32Array;
// let fbProp: Int8Array;

// async function waitms(time: number): Promise<void> {
...
//         forcebitsShader.draw(+slider.value);
//     }
...
//         fbVelArr.push(forceBit.vel.x, forceBit.vel.y);
//         let typeProp = 0;
//         typeProp |= (type === 'ERB' ? 0 : 1) << 7;
//         fbPropArr.push(typeProp);
//     }

//     fbPos = new Float32Array(fbPosArr);
//     fbVel = new Float32Array(fbVelArr);
//     fbProp = new Int8Array(fbPropArr);

//     forcebitsShader.start(gl, fbPos, fbVel, fbProp);
// }
